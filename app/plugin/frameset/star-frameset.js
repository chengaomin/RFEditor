...
(function($) {
    ...
    var rowLineCss = 'position:absolute;overflow:hidden;height:1px;border-top:1px solid #d7d7d7;opacity: 0.3;background:#f8f8f8;cursor:n-resize;z-index: 9999',
        colLineCss = 'position:absolute;overflow:hidden;width:1px;border-left:1px solid #d7d7d7;opacity: 0.3;background:#f8f8f8;cursor:e-resize;z-index: 9999';
    var margin = 3;
    ...
    function getFrameExtent(framesetExtent, rowsOrCols) {
        ...
        if (typeof allIndex === 'number') {
            res[allIndex] = framesetExtent - plusAll(res)+20;
        }
        return res;
    }
    ...
    StarFrameset.prototype = {
        init: function() {
            ...
            if (rows) {
                if (rows=='100%'){
                    framesetHeight=document.documentElement.clientHeight-70;
                }
